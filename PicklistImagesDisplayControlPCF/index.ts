...
import thecontrol = require("./PicklistImagesDisplayControl");

export class PicklistImagesDisplayControlPCF implements ComponentFramework.StandardControl<IInputs, IOutputs> {
